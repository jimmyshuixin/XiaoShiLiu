...
const columns = [
  ...
  { key: 'user_id', label: '光隅号', type: 'user-link', sortable: false, maxLength: 15 },
...
const formFields = [
  { key: 'user_id', label: '光隅号', type: 'text', required: true, placeholder: '请输入光隅号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '光隅号', placeholder: '搜索光隅号' },
